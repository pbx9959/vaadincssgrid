 ...
 */
@Route("headertwocolfooterresponsivelinebased")
@Tag("header-twocol-footer-responsive-linebased")
@HtmlImport("header-twocol-footer-responsive-linebased.html")
public class HeaderTwoColFooterResponsiveLineBasedPos extends PolymerTemplate<TemplateModel> {
    ...
    public HeaderTwoColFooterResponsiveLineBasedPos() {
